    ...
    const save = async (event) => {
        ...
        if(errors.length > 0){
            ...
            const requestOptions = {
                ...
                body: JSON.stringify({ "operatorId": config.operatorId,"id": userData.Id,"name": name.value,"nickname": nickname.value,"password": password.value,"level": level.value, "active": userData.active})
              }
